...
DECLARE
  ...
  IS
   	SELECT 	 
		OM_PF_PROMOTION_MONEY_TIER_TMP.PF_MINIMUM_TIER_QTY,
		OM_PF_PROMOTION_MONEY_TIER_TMP.PF_MAXIMUM_TIER_QTY,
		OM_PF_PROMOTION_MONEY_TIER_TMP.PF_PM_AMT,
		OM_PF_PROMOTION_MONEY_TIER_TMP.ID_CREATED,
		OM_PF_PROMOTION_MONEY_TIER_TMP.DATE_TIME_CREATED,
		OM_PF_PROMOTION_MONEY_TIER_TMP.ID_MODIFIED,
		OM_PF_PROMOTION_MONEY_TIER_TMP.DATE_TIME_MODIFIED,
		OM_PF_PROMOTION_MONEY_TIER_TMP.PF_TRANSFER_IND,
		OM_PF_PROMOTION_MONEY_TIER_TMP.PF_PM_ID,
		OM_PROMOTIONAL_MONEY.SYS_PM_ID
	FROM OM_PF_PROMOTION_MONEY_TIER_TMP, OM_PROMOTIONAL_MONEY
	WHERE OM_PF_PROMOTION_MONEY_TIER_TMP.PF_PM_ID=OM_PROMOTIONAL_MONEY.PM_NBR
...
BEGIN
  ...
  LOOP
    ...
    BEGIN
	    ...
	    EXCEPTION	
			...
			INSERT INTO OM_PF_PROMOTION_MONEY_TIER_BAD 
			( 
				PF_PM_ID,
				PF_MINIMUM_TIER_QTY,
				PF_MAXIMUM_TIER_QTY,
			 ...
			 VALUES  
			 (  
				rec_promotionalmoneydtl.PF_PM_ID,
				rec_promotionalmoneydtl.PF_MINIMUM_TIER_QTY,
				rec_promotionalmoneydtl.PF_MAXIMUM_TIER_QTY,
				rec_promotionalmoneydtl.PF_PM_AMT,
				rec_promotionalmoneydtl.ID_CREATED,
				...
				rec_promotionalmoneydtl.ID_MODIFIED,
				rec_promotionalmoneydtl.DATE_TIME_MODIFIED,
				rec_promotionalmoneydtl.PF_TRANSFER_IND,
				v_err_code ,
				v_err_msg ,
				SYSDATE
			 ) ;
  ...
  INSERT INTO OM_PF_PROMOTION_MONEY_TIER_BAD 
	( 
	 ...
	 SELECT 	 
		"PROMO".PF_PM_ID,
		"PROMO".PF_MINIMUM_TIER_QTY,
		"PROMO".PF_MAXIMUM_TIER_QTY,
		"PROMO".PF_PM_AMT,
		"PROMO".ID_CREATED,
		...
		SYSDATE
	 FROM OM_PF_PROMOTION_MONEY_TIER_TMP "PROMO"
	 WHERE NOT EXISTS
		( SELECT 1
		  FROM OM_PF_PROMOTION_MONEY_TIER_TMP, OM_PROMOTIONAL_MONEY
		  WHERE OM_PF_PROMOTION_MONEY_TIER_TMP.PF_PM_ID = OM_PROMOTIONAL_MONEY.PM_NBR
		  AND OM_PROMOTIONAL_MONEY.TYPE = 'PM'
		  AND OM_PF_PROMOTION_MONEY_TIER_TMP.PF_PM_ID = "PROMO".PF_PM_ID
		);
END;
/
