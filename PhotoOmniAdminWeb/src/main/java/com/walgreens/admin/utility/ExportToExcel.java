...
/**
 * 
 * @author CTS Represent a utility class for generate excel files this class can
...
/**
	...
	protected void writeFloatValue(ResultSet rst,
	 ...
	 */
	private static void writeTitle(HSSFWorkbook wb, String title, int fieldCount) {
		HSSFSheet sheet = wb.getSheetAt(0);
